/*  This file contains the implementation of various interval selection algorithms,
    for online and offline settings, and with unit or porportional weight functions.
